        ...
        <form class="form-horizontal" role="form" id="form">
		      ...
		      <div class="form-body">
		          <div class="form-group">
		              ...
		              <div class="col-md-6">
		                  <input type="text" class="form-control" name="name" value="${district.attrs.name}" placeholder="请输入城市名称">
		              </div>
		              <div class="col-md-3"></div>
		          </div>
		          <div class="form-group">
		              <label class="col-md-3 control-label"><font color="red">*</font>所在城市：</label>
		              <div class="col-md-6">
		                  <input type="text" class="form-control" name="longitude" value="${district.attrs.longitude}"  placeholder="请输入经度">
		              </div>
		              <div class="col-md-3"></div>
		          </div>
		          <div class="form-group">
